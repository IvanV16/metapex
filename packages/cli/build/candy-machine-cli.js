        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, Promise.all(various_1.chunks(Array.from(Array(keys.length).keys()), 500).map(function (allIndexesInSlice) { return __awaiter(void 0, void 0, void 0, function () {
                        var i, key, thisSlice, name_1, uri, cacheItem, json, e_1, body, parsed, check, e_2, text;
...
programCommand('show')
    ...
    .option('-r, --rpc-url <string>', 'custom rpc url since this is a heavy command')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, cacheName, rpcUrl, cachePath, cacheContent, walletKeyPair, anchorProgram, _b, candyMachine, machine, e_3, config;
...
programCommand('mint_tokens')
    ...
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, cacheName, number, rpcUrl, parsedNumber, cacheContent, configAddress, i;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _b.label = 1;
            case 1:
                if (!(i < parsedNumber)) return [3 /*break*/, 4];
                return [4 /*yield*/, mint_1.mint(keypair, env, configAddress, cacheContent.program.uuid, rpcUrl)];
            case 2:
                _b.sent();
                loglevel_1.default.info("token " + i + " minted");
                _b.label = 3;
            case 3:
                i++;
                return [3 /*break*/, 1];
            case 4:
                loglevel_1.default.info("minted " + parsedNumber + " tokens");
                return [2 /*return*/];
        }
    });
}); });
