...
function upload(files, cacheName, env, keypair, totalNFTs, storage, retainAuthority, mutable, rpcUrl, ipfsCredentials, awsS3Bucket) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var uploadSuccessful, savedContent, cacheContent, existingInCache, seen, newFiles, images, SIZE, walletKeyPair, anchorProgram, config, tick, lastPrinted, i, image, imageName, index, link, imageLink, manifestPath, manifestContent, manifest, manifestBuffer, res, exx_1, er_1, keys, e_1;
        var _e, _f, _g;
        var _this = this;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 2:
                    ...
                    imageLink = (_d = (_c = cacheContent === null || cacheContent === void 0 ? void 0 : cacheContent.items) === null || _c === void 0 ? void 0 : _c[index]) === null || _d === void 0 ? void 0 : _d.imageLink;
                    if (!(!link || !cacheContent.program.uuid)) return [3 /*break*/, 16];
