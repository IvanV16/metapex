    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                mintInfo = spl_token_1.MintLayout.decode(Buffer.from(mintAccount.data));
                return [2 /*return*/, {
                        key: mintKey,
                        info: mintInfo,
                    }];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                creatorTokenInfo = spl_token_1.AccountLayout.decode(Buffer.from(creatorTokenAccount.data));
